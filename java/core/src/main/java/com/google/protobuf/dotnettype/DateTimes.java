...
public class DateTimes {
  ...
  protected static final DateTime MIN_VALUE = DateTime.newBuilder().setValue(MAXMIN_MIN).setScale(TimeSpanScale.MINMAX).build();
  protected static final DateTime MAX_VALUE = DateTime.newBuilder().setValue(MAXMIN_MAX).setScale(TimeSpanScale.MINMAX).build();

  public static final Calendar defaultCalendar() {
    Calendar calendar = Calendar.getInstance();
    calendar.setTimeInMillis(MIN_MILLISECONDS);
    return calendar;
  }
